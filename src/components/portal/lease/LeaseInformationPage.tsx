    ...
    <div className="space-y-5">
      ...
      <header className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0 space-y-2">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="text-xs font-medium uppercase tracking-wide text-[var(--harbor-ink)]/50">
              {lease.leaseNumber}
            </span>
          </div>
      ...
      >
        ...
        {lease.occupants.length === 0 ? (
          <p className="mt-3 text-sm text-[var(--harbor-ink)]/65" role="status">
          ...
          <ul className="mt-4 divide-y divide-[var(--harbor-deep)]/10">
            {lease.occupants.map((person) => (
              ...
              >
                ...
                <span className="text-sm text-[var(--harbor-ink)]/60">
                  {person.role}
                </span>
              </li>
            ))}
  ...
  return (
    ...
    >
      ...
      <ul className="mt-4 flex flex-wrap gap-2">
        ...
        <li>
          <Link href="/portal/renewal" className="btn btn-outline btn-sm">
            Request Renewal
          </Link>
        </li>
        <li>
          <Link href="/portal/move-out" className="btn btn-outline btn-sm">
            Submit Move-Out Notice
          </Link>
        </li>
        <li>
          <Link href="/portal/messages" className="btn btn-ghost btn-sm gap-1">
            <Mail className="h-4 w-4" aria-hidden="true" />
            Contact Management
          </Link>
        </li>
