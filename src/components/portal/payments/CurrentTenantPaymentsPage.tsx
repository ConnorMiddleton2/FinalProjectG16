  ...
  return (
    ...
    >
      <form
        ...
        aria-labelledby={titleId}
        tabIndex={-1}
        className="w-full max-w-md space-y-4 rounded-2xl bg-white p-5 shadow-xl outline-none"
      ...
      >
        ...
        <fieldset className="space-y-2">
          <legend className="text-sm text-[var(--harbor-muted)]">Type</legend>
        ...
        <div className="flex flex-wrap justify-end gap-2">
          ...
          <button type="submit" className="btn btn-neutral btn-sm min-h-11">
            Save summary
          </button>
        </div>
      </form>
